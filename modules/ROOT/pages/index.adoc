...
. *Obtain an API key*
  ...
  * Visit the https://developer.ted.europa.eu/home[**TED Developer Portal**]footnote:portal[{dev-portal}]. 
  * Log in with your **EU Login**footnote:eu-login[{eu-login}] credentials. 
