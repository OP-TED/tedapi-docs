...
** See xref:publish.adoc#_notice_lifecycle[Notice lifecycle (Publication API)].
...
** See xref:publish.adoc#_notice_lifecycle[Notice lifecycle (Publication API)] for status definitions.
