...
The Publications Office (OP) has developed a range of applications for the submission, validation, processing, visualisation and dissemination of eForms notices. These went into production on 14 November 2022 and serve as a programmatic gateway that connects external systems to TED services.  The TED APIs (or API suite), known as "Ted API", allow application developers to connect their 3rd party applications to the TED web services. Using TED APIs you can create applications that:
...
.. Visit the https://ted.europa.eu/developer-portal[TED Developer Portal]. 
