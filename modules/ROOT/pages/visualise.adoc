...
- **Preview Environment:**  
  * link:https://api.preview.ted.europa.eu/swagger/index.html#/Visualisation/render[Access Render Operation]
  * link:https://api.preview.ted.europa.eu/swagger/index.html#/Visualisation/renderWithCallback[Access Render With Callback Operation]
