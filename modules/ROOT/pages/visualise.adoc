...
- **Preview Environment:**  
  * link:https://api.preview.ted.europa.eu/swagger/index.html#/Visualisation/render[Swagger: Access Render Operation]
  * link:https://api.preview.ted.europa.eu/swagger/index.html#/Visualisation/renderWithCallback[Swagger: Access Render With Callback Operation]
