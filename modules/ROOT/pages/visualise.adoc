...
- **Preview Environment:**  
  * link:https://api.preview.ted.europa.eu/swagger-ui/index.html#/Visualisation/renderNotice[Swagger: Access Render Operation]
  * link:https://api.preview.ted.europa.eu/swagger-ui/index.html#/Visualisation/renderNoticeWithCallback[Swagger: Access Asynchronous Render Operation]

- **Production Environment:**  
  * link:https://api.ted.europa.eu/swagger-ui/index.html#/Visualisation/renderNotice[Swagger: Access Render Operation]
  * link:https://api.ted.europa.eu/swagger-ui/index.html#/Visualisation/renderNoticeWithCallback[Swagger: Access Asynchronous Render Operation]
