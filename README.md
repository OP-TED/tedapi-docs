...
Please use the [**TED Developer Docs**](https://docs.ted.europa.eu/home/index.html) portal if you want to read the [**TED API Documentation**](https://docs.ted.europa.eu/api/latest/index.html) .
